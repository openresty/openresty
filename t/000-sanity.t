...
all:
	...
	cd $OPENRESTY_BUILD_DIR/nginx-1.28.0 && $(MAKE)
...
install: all
	...
	cd $OPENRESTY_BUILD_DIR/lua-resty-core-0.1.32 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_LIB_DIR=/usr/local/openresty/lualib INSTALL='$(INSTALL)'
	...
	cd $OPENRESTY_BUILD_DIR/nginx-1.28.0 && $(MAKE) install DESTDIR=$(DESTDIR)
...
install: all
	...
	cd $OPENRESTY_BUILD_DIR/lua-resty-core-0.1.32 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_LIB_DIR=./lualib INSTALL='$(INSTALL)'

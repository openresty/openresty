...
all:
	...
	cd $OPENRESTY_BUILD_DIR/nginx-1.2.3 && $(MAKE)
...
install: all
	...
	cd $OPENRESTY_BUILD_DIR/lua-resty-dns-0.06 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_LIB_DIR=/usr/local/openresty/lualib INSTALL=$OPENRESTY_BUILD_DIR/install
	...
	cd $OPENRESTY_BUILD_DIR/lua-resty-redis-0.13 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_LIB_DIR=/usr/local/openresty/lualib INSTALL=$OPENRESTY_BUILD_DIR/install
	...
	cd $OPENRESTY_BUILD_DIR/nginx-1.2.3 && $(MAKE) install DESTDIR=$(DESTDIR)
...
install: all
	...
	cd $OPENRESTY_BUILD_DIR/lua-resty-dns-0.06 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_LIB_DIR=/opt/blah/lualib INSTALL=$OPENRESTY_BUILD_DIR/install
	...
	cd $OPENRESTY_BUILD_DIR/lua-resty-redis-0.13 && $(MAKE) install DESTDIR=$(DESTDIR) LUA_LIB_DIR=/opt/blah/lualib INSTALL=$OPENRESTY_BUILD_DIR/install
